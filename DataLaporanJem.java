...
public class DataLaporanJem {
    ...
    public DataLaporanJem() {
    }

    public DataLaporanJem(String imageName, String imageAlamat, String imageTanggal, String imageEmail, String imageDetail, String imageURL) {
