...
public class DetailLaporanJem extends AppCompatActivity{
    ImageView imageView;
    ...
    private DatabaseReference first = databaseReference.child("Jembatan");


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detail_laporan_jem);
    ...
    protected void onStart() {
        ...
        first.addValueEventListener(new ValueEventListener() {
            ...
            private String grimaces(String Jembatan) {
                storageReference.child(Jembatan).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    @Override
