...
public class laporan_taman extends AppCompatActivity {
    Calendar myCalendar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laporan_taman);
        storageReference = FirebaseStorage.getInstance().getReference("Taman");
        databaseReference = FirebaseDatabase.getInstance().getReference("Taman");
        ...
        progressDialog = new ProgressDialog(laporan_taman.this);// context name as per your project name
        ...
        btPlacesAPI.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ActivityCompat.checkSelfPermission(laporan_taman.this
                        , Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                    getLocation();
                } else {
                    ActivityCompat.requestPermissions(laporan_taman.this
        ...
        Time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(laporan_taman.this, date,
        ...
        btnupload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                UploadImage();
                Intent succes = new Intent(laporan_taman.this, allLaporan_taman.class);
        ...
        fusedLocationProviderClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
            ...
            public void onComplete(@NonNull Task<Location> task) {
                ...
                if (location != null) {
                    ...
                    try {
                        Geocoder geocoder = new Geocoder(laporan_taman.this, Locale.getDefault());
    ...
    public void UploadImage() {
        ...
        if (FilePathUri != null) {
            ...
            Toast.makeText(laporan_taman.this, "Ada Kesalahan! Mohon Perika Laporan Anda", Toast.LENGTH_LONG).show();
